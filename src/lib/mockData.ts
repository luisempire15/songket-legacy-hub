...
export interface Product {
  ...
  total_sold: number;
  certified: boolean; // mirrors approved certificate
}
...
export interface CertificateRequest {
  ...
  seller_id: string;
  umkm_name: string;
  proof_image: string; // data url or product image url
  notes: string;
  status: CertStatus;
...
export type UmkmStatus = "Pending" | "Approved" | "Rejected";
...
const baseProducts: Omit<Product, "id" | "image_url" | "certified" | "seller_id">[] = [
  ...
  { name: "Sarung Tajung Garis Klasik", umkm_name: "Tenun Musi Indah", description: "Sarung Tajung garis klasik dengan kombinasi warna maroon dan emas. Pilihan abadi untuk ibadah dan acara formal.", price: 485000, stock: 22, category: "Tajung", material: "Katun Sutra", weight: 420, rating: 4.7, total_reviews: 64, total_sold: 234 },
...
// Map UMKM names to seller IDs (the seed seller owns Toko Sriwijaya Jaya)
const sellerForUmkm: Record<string, string> = {
...
export const seedProducts: Product[] = baseProducts.map((p, i) => ({
  ...
  // Some initial certified items for showcase
  certified: i === 0 || i === 3 || i === 6,
}));

// Backwards-compat export (used by some pages for seeding before context loads)
...
export const seedOrders: Order[] = [
  {
    ...
    items: [
      { product_id: "prod-002", product_name: "Selendang Jumputan Sekar Jagad", umkm_name: "Rumah Jumputan Ratu", seller_id: "u-seller-2", qty: 2, price: 285000, image_url: seedProducts[1].image_url },
    ],
  ...
  },
  {
    ...
    buyer_name: "Budi Santoso",
    items: [
      { product_id: "prod-001", product_name: "Songket Lepus Emas Klasik", umkm_name: "Toko Sriwijaya Jaya", seller_id: "u-seller", qty: 1, price: 3850000, image_url: seedProducts[0].image_url },
    ],
  ...
  },
  {
    ...
    items: [
      { product_id: "prod-005", product_name: "Songket Tabur Bintang Emas", umkm_name: "Toko Sriwijaya Jaya", seller_id: "u-seller", qty: 1, price: 1850000, image_url: seedProducts[4].image_url },
      { product_id: "prod-010", product_name: "Selendang Jumputan Sogan", umkm_name: "Rumah Jumputan Ratu", seller_id: "u-seller-2", qty: 3, price: 195000, image_url: seedProducts[9].image_url },
    ],
...
export const seedCertificates: CertificateRequest[] = [
  {
    id: "CERT-001",
    product_id: "prod-005",
    ...
    proof_image: seedProducts[4].image_url,
  ...
  },
  {
    ...
    seller_id: "u-seller",
    umkm_name: "Toko Sriwijaya Jaya",
    proof_image: seedProducts[0].image_url,
...
export const seedUmkmApps: UmkmApplication[] = [
  {
    id: "UMKM-101",
